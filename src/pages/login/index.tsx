  ...
  return (
    <div className="flex h-full w-full items-center justify-center">
      <form
        ...
        className="flex h-3/5 w-4/5 flex-col items-center justify-around gap-2 rounded-lg border border-[--bor-m] bg-black bg-opacity-10 px-8 py-16 backdrop-blur-2xl lg:w-2/5 lg:px-32"
      >
